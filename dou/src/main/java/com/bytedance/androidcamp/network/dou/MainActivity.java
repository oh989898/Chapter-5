...
public class MainActivity extends AppCompatActivity {
    ...
    private void initService() {
        retrofit = new Retrofit.Builder()
                .baseUrl(IMiniDouyinService.PATH)
    ...
    private void postVideo() {
        ...
        Call<PostVideo> call=miniDouyinService.postVideo("3170105781",
                "CTT",coverImagePart,videoPart);
    ...
    public void fetchFeed(View view) {
        ...
        Call<GetVideo> call=miniDouyinService.getVideos();
        call.enqueue(new Callback<GetVideo>() {
            @Override
            public void onResponse(Call<GetVideo> call, Response<GetVideo> response) {
                if(response.isSuccessful()&&response.body()!=null){
                    GetVideo feed=response.body();
                    List<Video> videos=feed.getGetVideo();
